...
makes it still worthwhile. But please understand that it will not achieve a whole lot more than it can do right now. Consider running e.g. 
SymPy in a WASM webworker if you need more (see here for a demo: [SymPy live](https://live.sympy.org/).
