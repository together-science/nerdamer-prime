...
declare namespace nerdamer {
    ...
    export interface ModuleFunction {
        ...
        /**
         * Number of function arguments, -1 for variable arguments or an tuple containing minimum and maximum number of
         * arguments.
         */
        numargs: int | [int, int];
    ...
    export interface Expression {
         ...
         * Plotting for the demo is accomplished using this. The order of the parameters is in alphabetical order by
         * default but an argument array can be provided with the desired order.
         *
         ...
         * equation. If no solutions are found then an empty array is returned. It can solve for multivariate
         * polynomials up to the third degree. After which it can solve numerically for polynomials up to the 100th
         * degree. If it's a univariate equation it will attempt to solve it using numerical methods.
         *
         * @example
        ...
        /**
         * Checks to see if the expression's value equals a number. Compares the direct value returned. The function
         * will not check for all possible cases. To avoid this call evaluate.
         *
         * @example
     ...
     *
     * @param expression Returns the appropriate value if possible otherwise it returns the function with the simplified
     *   expression.
