...
it('Should convert from TeX', () => {
    ...
    expect(nerdamer.convertFromLaTeX('\\begin{matrix} \\begin{matrix}1 & 2 \\\\ 7 & 8\\end{matrix} & 2+9 \\\\ 7 & 8\\end{matrix}').toString()).toEqual('matrix([matrix([1,2],[7,8]),11],[7,8])');
