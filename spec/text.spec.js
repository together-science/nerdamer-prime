...
describe('The text function', () => {
    ...
    const testCases = [
        ...
        },
        {
            ...
            expected_recurring:
                "95.21''",
        },
        {
