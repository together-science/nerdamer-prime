...
describe('Solve', function () {
    ...
    it('should solve correctly', function () {
        ...
        expect(nerdamer('solve(m*x^9+n,x)').toString()).toEqual(
        ...
        expect(nerdamer('solve(sqrt(97)x^2-sqrt(13)x+sqrt(14)x+sqrt(43)x^2+sqrt(3)*sqrt(101)=0,x)').toString()).toEqual(
        ...
        expect(nerdamer('solve(a*y^2*x^3-1, x)').toString()).toEqual(
        ...
        expect(nerdamer('solve(x^3+y^3=3, x)').toString()).toEqual(
        ...
        expect(nerdamer('solve(x=2^x/4,x)').toString()).toEqual('[169762849/547786549,4]');
