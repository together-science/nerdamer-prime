...
describe('Basic operations', function () {
    ...
    it('should raise to power correctly', function () {
        expect(parse('2^3')).toEqual(8);
    });
    it('should parse scientific notation correctly', function () {
        expect(parse('1.234e+1')).toEqual(12.34);
    });
    it('should parse non-normalized scientific notation correctly', function () {
...
describe('Order of precedence', function () {
    ...
    it('should recognize ^ is right associative', function () {
...
describe('Percentages', function () {
    ...
    it('should add percentages', function () {
        expect(parse('5%+5%')).toEqual(0.1);
    });
    it('should multiply percentages', function () {
        expect(parseFloat(parse('10%*10%').toFixed(2))).toEqual(0.01);
    });
    it('should multiply percentages by numbers', function () {
        expect(parse('100*10%')).toEqual(10);
    });
});

describe('Functions', function () {
    it('should calculate functions', function () {
        expect(_$(parse('sin(1)'))).toEqual(_$(0.8414709848078965));
    });
    it('should calculate functions', function () {
        expect(_$(parse('sin(sin(2))'))).toEqual(_$(0.7890723435728884));
    });
    it('should add with functions', function () {
        expect(_$(parse('sin(sin(2))+4'))).toEqual(_$(4.789072343572888));
    });
    it('should handle function with arguments', function () {
        expect(parse('max(4,6,3)')).toEqual(6);
    });
    it('should handle function with arguments with operations', function () {
        expect(parse('max(4,5+7,3)')).toEqual(12);
    });
    it('should handle function with arguments with operations and subsequent operations', function () {
...
describe('Modulus', function () {
    ...
    it('should add with modulus', function () {
        expect(parse('10%4+6')).toEqual(8);
    });
    it('should multiply with modulus', function () {
        expect(parse('10%4*8')).toEqual(16);
    });
    it('should add and multiply with modulus', function () {
        expect(parse('2+10%4*8')).toEqual(18);
    });
    it('should respect modulus in functions', function () {
        expect(parse('max(3,2+10%4*8,5)')).toEqual(18);
    });
    it('should respect modulus with percentages', function () {
        expect(parse('8000%%8')).toEqual(0);
    });
    it('should correctly handle modulus left assoc', function () {
...
describe('Brackets', function () {
    ...
    it('should respect parentheses within parentheses', function () {
        expect(parse('3*(4+(2+1))')).toEqual(21);
    });
    it('should recognize vectors', function () {
        expect(parse('[1,2,[3,4]]').toString()).toEqual('[1,2,[3,4]]');
    });
    it('should handle multiple levels of brackets', function () {
...
describe('Substitutions', function () {
    it('should substitute x', function () {
